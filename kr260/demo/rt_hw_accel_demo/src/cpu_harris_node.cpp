...
void HarrisNodeCPU::harrisImage(
    const cv::Mat& in_img,
...
void HarrisNodeCPU::harrisImage2(
    const cv::Mat& in_img,
    cv::Mat& harris_img) const
{
...
RCLCPP_COMPONENTS_REGISTER_NODE(image_proc::HarrisNodeCPU)
