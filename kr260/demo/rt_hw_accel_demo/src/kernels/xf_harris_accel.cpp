...
void cornerHarris_accel(
    ...
    #pragma HLS INTERFACE m_axi     port=img_out  offset=slave bundle=gmem1  // NOLINT
...
//         }
//     }
    // TODO: Add stream loading

    xf::cv::Array2xfMat<INPUT_PTR_WIDTH, XF_8UC1, HEIGHT, WIDTH, NPIX>(img_in, in_mat);
